...
import { T_lettersLowerCase } from "../types/strings";
...
type T_paletteNames = "matrix" | "outrunA" | "outrunB" | "outrunC" | "outrunD" | "techandtribal" | "tron";
type T_variationNames = T_lettersLowerCase;
...
const palettes: {
	[a in T_paletteNames]: {
		[b in T_variationNames]?: T_colourEntries;
	};
} = {
